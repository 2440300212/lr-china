...
namespace Xerath
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("远古巫灵-泽拉斯", ChampionName, true);
            ...
            Config.SubMenu("R").AddItem(new MenuItem("EnableRUsage", "自动大招").SetValue(true));
            Config.SubMenu("R").AddItem(new MenuItem("rMode", "模式").SetValue(new StringList(new[] { "Normal", "Custom delays", "OnTap"})));
            Config.SubMenu("R").AddItem(new MenuItem("rModeKey", "OnTap快捷键").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
            ...
            Config.SubMenu("R").AddItem(new MenuItem("PingRKillable", "击杀提醒 (本地)").SetValue(true));
            Config.SubMenu("R").AddItem(new MenuItem("BlockMovement", "打断大招").SetValue(false));
            Config.SubMenu("R").AddItem(new MenuItem("OnlyNearMouse", "攻击鼠标附近敌人").SetValue(false));
            ...
            Config.SubMenu("Misc").AddItem(new MenuItem("AutoEGC", "使用E防近身").SetValue(true));


            //Damage after combo:
            var dmgAfterComboItem = new MenuItem("DamageAfterR", "显示3XR伤害").SetValue(true);
            ...
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("RRangeM", "R 范围 (本地)").SetValue(new Circle(false,
