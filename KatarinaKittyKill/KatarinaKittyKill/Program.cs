...
namespace KatarinaKittyKill
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            menu = new Menu("不详之刃-卡特琳娜", ChampionName, true);

            //Orbwalker submenu
            var orbwalkerMenu = new Menu("走砍选项", "my_Orbwalker");
            ...
            //Key 
            menu.AddSubMenu(new Menu("快捷键", "Key"));
            menu.SubMenu("Key")
                .AddItem(
            ...
            menu.SubMenu("Key")
                .AddItem(
                    new MenuItem("lastHit", "尾刀!").SetValue(
            ...
            menu.SubMenu("Key")
                .AddItem(
                    new MenuItem("jFarm", "打野!").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
            menu.SubMenu("Key")
                .AddItem(
                    new MenuItem("Wardjump", "逃跑/瞬眼").SetValue(
                        new KeyBind(menu.Item("Flee_Key").GetValue<KeyBind>().Key, KeyBindType.Press)));

            //Combo menu:
            menu.AddSubMenu(new Menu("连招选项", "Combo"));
            menu.SubMenu("Combo").AddItem(new MenuItem("selected", "重点攻击目标").SetValue(true));
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("eDis", "E距离 >").SetValue(new Slider(0, 0, 700)));
            menu.SubMenu("Combo").AddItem(new MenuItem("smartE", "R冷却智能E").SetValue(false));
            menu.SubMenu("Combo").AddItem(new MenuItem("UseRCombo", "使用 R").SetValue(true));
            menu.SubMenu("Combo")
                .AddItem(new MenuItem("comboMode", "连招模式").SetValue(new StringList(new[] {"QEW", "EQW"}, 0)));
            ...
            menu.SubMenu("Harass")
                .AddItem(new MenuItem("harassMode", "骚扰模式").SetValue(new StringList(new[] {"QEW", "EQW", "QW"}, 2)));
            ...
            menu.SubMenu("Farm").AddItem(new MenuItem("UseQHit", "使用 Q 尾刀").SetValue(false));
            menu.SubMenu("Farm").AddItem(new MenuItem("UseWHit", "使用 W 尾刀").SetValue(false));


            //killsteal
            menu.AddSubMenu(new Menu("抢人头选项", "KillSteal"));
            menu.SubMenu("KillSteal").AddItem(new MenuItem("smartKS", "智能抢人头").SetValue(true));
            menu.SubMenu("KillSteal").AddItem(new MenuItem("wardKs", "使用瞬眼抢人头").SetValue(true));
            menu.SubMenu("KillSteal").AddItem(new MenuItem("rKS", "使用R抢人头").SetValue(true));
            menu.SubMenu("KillSteal").AddItem(new MenuItem("rCancel", "取消R抢人头").SetValue(false));

            //Misc Menu:
            menu.AddSubMenu(new Menu("其他选项", "Misc"));
            menu.SubMenu("Misc").AddItem(new MenuItem("packet", "使用封包").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("dfg", "使用 DFG").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("ignite", "使用点燃").SetValue(true));
            menu.SubMenu("Misc")
                .AddItem(new MenuItem("igniteMode", "点燃模式").SetValue(new StringList(new[] {"连招", "抢人头"}, 0)));
            menu.SubMenu("Misc").AddItem(new MenuItem("autoWz", "自动W敌人").SetValue(true));
