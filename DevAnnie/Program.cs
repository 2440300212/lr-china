...
namespace DevAnnie
{
    class Program
    {
        ...
        {
            Config = new Menu("Dev黑暗之女-安妮", "DevAnnie", true);
            ...
            Config.SubMenu("Mode").AddItem(new MenuItem("ModeType", "模式类型").SetValue(new StringList(new[] { "SoloQ", "Support" })));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("UseQHarassLastHit", "使用 Q 尾刀").SetValue(true));
