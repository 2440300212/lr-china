...
namespace AutoLevelup
{
    ...
    .Any(mastery => mastery.Id == 100 && mastery.Points == 1))
            ...
            else if (Player.BaseSkinName == "Cassiopeia") abilitySequence = new int[] { 1, 3, 2, 3, 3, 4, 3, 1, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
            ...
            else if (Player.BaseSkinName == "KogMaw") abilitySequence = new int[] { 2, 3, 1, 2, 2, 4, 2, 1, 2, 1, 4, 1, 1, 3, 3, 4, 3, 3 };
            ...
            else if (Player.BaseSkinName == "MasterYi") abilitySequence = new int[] { 1, 3, 2, 3, 3, 4, 3, 1, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
    ...
    .Any(mastery => mastery.Id == 100 && mastery.Points == 1))
            ...
            else if (Player.BaseSkinName == "Soraka") abilitySequence = new int[] { 1, 2, 3, 1, 1, 4, 1, 2, 1, 2, 4, 2, 2, 3, 3, 4, 3, 3 };
